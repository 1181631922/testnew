...
import com.fanyafeng.testnew.FrascoOkhttp.instrumentation.InstrumentedDraweeView;
...
//			  .setLowResImageRequest(ImageRequest.fromUri(lowResUri))//先下载显示低分辨率的图
    ...
    public static void init(final Resources resources) {
        if (sPlaceholderDrawable == null) {
            sPlaceholderDrawable = resources.getDrawable(R.color.main_white);
        }
        if (sErrorDrawable == null) {
            sErrorDrawable = resources.getDrawable(R.color.main_white);
        }
    }
